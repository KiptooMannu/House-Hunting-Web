    ...
    <div className="bg-surface font-body text-on-surface antialiased flex">
      ...
      <aside className="h-screen w-72 hide-scrollbar sticky left-0 top-0 overflow-y-auto bg-slate-50 dark:bg-slate-950 border-r border-slate-200/50 dark:border-slate-800/50 flex flex-col p-6 gap-2 z-50">
        ...
        <nav className="flex-grow space-y-1">
          <Link className="flex items-center gap-3 px-4 py-3 bg-white dark:bg-slate-900 text-primary dark:text-sky-400 rounded-xl shadow-sm duration-300 ease-in-out font-headline font-medium" to="/landlord">
            <span className="material-symbols-outlined">dashboard</span>
            <span>Dashboard</span>
          </Link>
          <Link className="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-900/50 rounded-xl hover:translate-x-1 transition-transform duration-300 ease-in-out font-headline font-medium" to="/houses">
            <span className="material-symbols-outlined">domain</span>
            <span>My Properties</span>
          </Link>
          <Link className="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-900/50 rounded-xl hover:translate-x-1 transition-transform duration-300 ease-in-out font-headline font-medium" to="#">
